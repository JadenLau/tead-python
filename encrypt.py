...
conv = [
        ...
        '3u7$8iv*/2lY^þ§=0VIDf4k,pT(Z5#;Jz:]\'Xy.%+@ex\n\t[`6÷abM)SQ_9<om~c|RLtAq"-CEhHGN}&>gFOUr{j!1dKns?BPWÿw \\',
        ...
        '3${Qe7;YL]y|gz*Ju!w+§C<%=TqþS5N:lG\n/,-iEk\\p0IA ?_sW(^H9#4÷Rc@Pb~dfBxj\tn6XvU>Khr&D12"8ot}[FO\'Mma.ÿZ`V)',
        ...
        '3%@"WjT5N)]Rh2M6r.1f>#:[pYiE9HZ_wD|{A+7<B4þ§GyCblPUF*k}Q`08gcnoVt÷sO\'L,/!u-a~^\tdx&=KI$mJzq;Xv (\ne\\S?ÿ',
        '3BG)D<oQOIt-Y8zd,?;:\'|Tpe}VAU!i7 .w$W"SgEb§þq%*#X@R0xyr9`s\n+h45a÷Fkc^K\t~{26j1=Z>\\(m]N&Jn_lCLHPv/[uMfÿ',
...
os.system('del /f encryption*.tmp')
print('Successful.\n')
print('\033[1mPlease check the hash below to keep your data safe.\033[0m\n\033[96m-------------------------------------------------------------------')
orig_hash = [
    '9cf9207cf16905e44ceab21858ea05b3',
    'c7f1e9b2ef8e5730ac902ce2f510b72a',
...
if i == 'e' or '-e' in __import__('sys').argv:
    ...
    fo.close()
    os.system(f'move {o} %temp%\{o}')
    os.system(f'start wt {lang} {para1} %temp%\{o} {para2}')
