orig_hash = [
    ...
    '556a41f9fa5aad9f43360ab0605a73bf',
    '448daad7236206909ec9eb7c32c7f372',
    '0f8315bc9f674f5402c5293c8d1ef5ca'
...
# conv1 =   '\n145141919810fcKyOuMoThErFuCkEr!QnMwTmDnMsLNbYSl23456789 `~!@#$%f(h&Vv*^&*()-=_+[{]}\\|;:\'",./<>?§\tÿþ÷'
...
if not ( '-e' in sys.argv or '-d' in sys.argv or '-r' in sys.argv or '--keygen' in sys.argv or '-k' in sys.argv ):
    tmp_clear()
    i = input('[e]ncode, [d]ecode, [r]un compiled and [k]ey generation [e,d,r,k]: ')
...
elif i == 'keygen' or '--keygen' in sys.argv or '-k' in sys.argv:
    keysource_d = conv1
